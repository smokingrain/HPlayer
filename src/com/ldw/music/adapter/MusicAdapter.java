...
import com.ldw.music.lib.BaseSwipListAdapter;
...
public class MusicAdapter extends BaseSwipListAdapter implements IConstants {
...
//	private IQueryFinished mIQueryFinished;
	...
	public MusicAdapter(Context context, ServiceManager sm, SlidingDrawerManager sdm) {
