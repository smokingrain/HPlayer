...
public class LyricAdapter extends BaseAdapter {
	...
	/** 歌词句子集合 */
	List<XRCLine> mLyricSentences = null;
	...
	public LyricAdapter(Context context) {
		mContext = context;
		mLyricSentences = new ArrayList<XRCLine>();
		mIndexOfCurrentSentence = 0;
	}

	/** 设置歌词，由外部调用， */
	public void setLyric(List<XRCLine> lyric) {
	...
	public Object getItem(int position) {
		return mLyricSentences.get(position).getWord();
	}
